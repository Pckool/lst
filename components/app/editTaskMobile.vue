<template>
	<div id="edit-task_cont_mobile">
		<div class="header">
			...
			<p class="close_icon" @click="close"><svg-icon src="/images/close.svg"/></p>
		</div>
...
export default defineComponent({
	...
	setup(props, ctx){
		...
		let animation;
		const text = ref<string>(task.value.text||'Pick up dog food')
